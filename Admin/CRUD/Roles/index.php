    ...
    <tbody>
        <?php foreach ($roles as $role) { ?>
            <tr>
                ...
                <td>
                    <a href="edit.php?id=<?php echo $role['id_role']; ?>">Modifier</a> |
                    <a href="delete.php?id=<?php echo $role['id_role']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur?');">Supprimer</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
